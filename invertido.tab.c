...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DIV = 19,                       /* DIV  */
  YYSYMBOL_ATRIBUI = 20,                   /* ATRIBUI  */
  YYSYMBOL_ABRE_PAR = 21,                  /* ABRE_PAR  */
  YYSYMBOL_FECHA_PAR = 22,                 /* FECHA_PAR  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DECLARACAO_VAR",
